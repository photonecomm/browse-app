...
module.exports = function() {
	...
	this.When(/^Customer check the Walgreens UI microservices Boilerplate text in home$/, function(){
		expect(element(by.css('.app-page')).isDisplayed()).to.eventually.be.true;
